...
#ifndef MAME_VIDEO_ATIRAGE128_H
#define MAME_VIDEO_ATIRAGE128_H
...
class atirage128_device : public pci_device
{
public:
	atirage128_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, uint32_t clock);
...
class atirage128pro_x86_device : public atirage128_device
{
public:
	atirage128pro_x86_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
...
DECLARE_DEVICE_TYPE(ATI_RAGE128PRO_X86, atirage128pro_x86_device)
